...
urlpatterns = [
    ...
    path("event/<int:event_id>/favorite/", views.favorite_create, name="favorite_create"),
    path("event/<int:event_id>/unfavorite/", views.favorite_remove, name="favorite_remove"),
]
