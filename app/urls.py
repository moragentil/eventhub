...
urlpatterns = [
    ...
    path("notifications/<int:id>/mark_read/", views.mark_notification_read, name="mark_notification_read"),
    path("notifications/<int:id>/mark_all_read/", views.mark_all_notifications_read, name="mark_all_notifications_read"),
]
